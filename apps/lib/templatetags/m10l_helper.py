...
@register.inclusion_tag('multilingual/templatetags/language_bar.html', takes_context=True)
...
# this is copy/paste from native django defaulttags for replace reverse by own
...
m10l_url = register.tag(m10l_url)
